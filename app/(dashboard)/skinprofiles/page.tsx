...
<div class="page">
  ...
  <div class="content">
    ...
    ${sp.aiExtractedData?`<div class='section'><div class='sec-title'>AI Skin Analysis</div><div class='info-grid'><div class='info-card'><div class='info-lbl'>Water Intake</div><div class='info-val'>${sp.aiExtractedData.waterIntake||'N/A'}</div></div><div class='info-card'><div class='info-lbl'>Diet</div><div class='info-val'>${sp.aiExtractedData.diet||'N/A'}</div></div><div class='info-card'><div class='info-lbl'>Junk Intake</div><div class='info-val'>${sp.aiExtractedData.junkIntake||'N/A'}</div></div><div class='info-card'><div class='info-lbl'>Sugar Intake</div><div class='info-val'>${sp.aiExtractedData.sugarIntake||'N/A'}</div></div><div class='info-card'><div class='info-lbl'>Allergies</div><div class='info-val'>${sp.aiExtractedData.allergies||'N/A'}</div></div><div class='info-card'><div class='info-lbl'>Current Skincare</div><div class='info-val'>${sp.aiExtractedData.currentSkincare||'N/A'}</div></div></div></div>`:''}
