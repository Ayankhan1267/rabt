...
const NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { id: 'whatsapp-commerce', label: 'WhatsApp Agent', icon: '💬', href: '/whatsapp-commerce', badge: 'AI', badgeColor: '#25D366' },
      { id: 'retention-agent', label: 'Retention Agent', icon: '🔁', href: '/retention-agent', badge: 'AI', badgeColor: '#F59E0B', roles: ['founder', 'admin', 'manager'] },
      { id: 'skin-analysis', label: 'Skin Analysis AI', icon: '🌿', href: '/skin-analysis', badge: 'AI', badgeColor: '#2D5F5A' },
      { id: 'content-agent', label: 'Content Agent', icon: '🎨', href: '/content-agent', badge: 'AI', badgeColor: '#EC4899' },
      { id: 'marketing-ai', label: 'Marketing AI', icon: '📢', href: '/marketing-ai', badge: 'AI', badgeColor: '#8B5CF6', roles: ['founder', 'admin', 'manager', 'marketing'] },
